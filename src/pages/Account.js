...
const TABLE_HEAD = [
  ...
  { id: 'collectable_amount', label: 'Collectable Amount', alignRight: false },
  { id: '' }
];
...
export default function User() {
  ...
  const USERLIST = [
    {
      ...
      tokenCollectable: ethCollectable ? formatEther(ethCollectable) : '--',
    ...
    },
    {
      ...
      tokenCollectable: ethCollectable ? parseFloat(formatEther(0)).toPrecision(2) : '--',
  ...
  return (
    <Page title="Service Dashboard | Account">
      <Container>
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{tokenCollectable}</TableCell>
